...
class Goal(Sequence):
    ...
    num_particles_for_opt: int = None 
    ...
    def repeat_seeds(self, num_seeds: int):
        ...
        return Goal(
            ...
            num_particles_for_opt=num_seeds,
        )
    ...
    def clone(self):
        return Goal(
            ...
            links_goal_pose=self.links_goal_pose,
            num_particles_for_opt=self.num_particles_for_opt,
            n_goalset=self.n_goalset,
        )
...
class RolloutBase:
    ...
    def rollout_fn(self, act, opt_progress=1.0, debug_flag=False):
        pass
    ...
    def __call__(self, act: T_BHDOF_float, opt_progress=1.0, debug_flag=False) -> Trajectory:
        return self.rollout_fn(act, opt_progress, debug_flag)
