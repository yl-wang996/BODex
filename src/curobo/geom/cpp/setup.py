...
extension_mod = Extension(
    "hppfcl_openmp_wrapper",
    sources=["hppfcl_parallel.cpp"],
    library_dirs=[lib_dir],
    libraries=[
        'hpp-fcl', 'boost_filesystem', 'qhull_r', 'octomap', 'octomath', 'assimp', 'stdc++', 'gcc_s', 'pthread', 'm', 'rt', 'c'
    ],
    ...
    extra_link_args=[f"-L{lib_dir}", "-lhpp-fcl", "-fopenmp"],
    language="c++"
)

# Setup function
setup(
    name="hppfcl_openmp_wrapper",
    version="0.1",
