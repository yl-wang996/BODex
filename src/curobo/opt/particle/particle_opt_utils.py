...
def scale_ctrl(ctrl, tendon_joints, use_root_pose, action_lows, action_highs, squash_fn: SquashType = SquashType.CLAMP):
    if len(ctrl.shape) == 1:
    ...
    if tendon_joints is not None:
        ctrl[..., tendon_joints[0]] = ctrl[..., tendon_joints[1]] = (ctrl[..., tendon_joints[0]] + ctrl[..., tendon_joints[1]]) / 2 
    ...
    if squash_fn == SquashType.CLAMP:
        ...
        if use_root_pose:
            ctrl[..., 3:7] = normalize_quaternion(ctrl[..., 3:7])
        return ctrl
