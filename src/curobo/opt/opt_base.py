...
class OptimizerConfig:
    ...
    def create_data_dict(
        ...
        child_dict["use_root_pose"] = rollout_fn.use_root_pose
        child_dict["tendon_joints"] = rollout_fn.tendon_joints
        child_dict["grad_groups"] = rollout_fn.grad_groups
...
class Optimizer(OptimizerConfig):
    def __init__(self, config: Optional[OptimizerConfig] = None) -> None:
        ...
        self.debug_info = {'steps': [], 'cost': [], 'mid_result': [], 'dist_error': []}
